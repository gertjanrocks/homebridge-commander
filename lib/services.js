...
module.exports.addCharacteristic = function(that) {
    ...
    if( ((that.type == "lightbulb") && that.settings.saturation) ||
        ((that.type == "custom")    && that.settings.saturation))
    {
    ...
    if( ((that.type == "lightbulb") && that.settings.colortemperature) ||
        ((that.type == "custom")    && that.settings.colortemperature))
    {
    ...
    //OutletInUse
    if( (that.type == "outlet") ||
        ((that.type == "custom")    && that.settings.outletinuse))
    {
    ...
    if( (that.type == "speaker") ||
        ((that.type == "custom")    && that.settings.mute))
    {
    ...
    if( ((that.type == "speaker") && that.settings.volume) ||
        ((that.type == "custom")    && that.settings.volume))
    {
    ...
    if( (that.type == "windowcovering") ||
        ((that.type == "custom")  && that.settings.currentposition))
    {
    ...
    //TargetPosition
    if( (that.type == "windowcovering") ||
        ((that.type == "custom")    && that.settings.targetposition))
    {
    ...
    //PositionState
    if( (that.type == "windowcovering") ||
        ((that.type == "custom")  && that.settings.positionstate))
    {
    ...
    if( ((that.type == "windowcovering") && that.settings.holdposition)||
        ((that.type == "custom")  && that.settings.holdposition))
    {
    ...
    if( ((that.type == "windowcovering") && that.settings.targethorizontaltiltangle) ||
        ((that.type == "custom")    && that.settings.targethorizontaltiltangle))
    {
    ...
    if( ((that.type == "windowcovering") && that.settings.targetverticaltiltangle) ||
        ((that.type == "custom")    && that.settings.targetverticaltiltangle))
    {
    ...
    if( ((that.type == "windowcovering") && that.settings.currenthorizontaltiltangle) ||
        ((that.type == "custom")    && that.settings.currenthorizontaltiltangle))
    {
    ...
    if( ((that.type == "windowcovering") && that.settings.currentverticaltiltangle) ||
        ((that.type == "custom")    && that.settings.currentverticaltiltangle))
    {
    ...
    if( ((that.type == "windowcovering") && that.settings.obstructiondetected) ||
        ((that.type == "custom")    && that.settings.obstructiondetected))
    {
